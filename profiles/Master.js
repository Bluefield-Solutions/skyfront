...
export const META = {
  ...
  tag: "Ausgewogen",
  accent: "#4cc6e0",
  desc: "Das Wunsch-Set: sanfter Einstieg, entzerrte Wellen-Kurve, zähere Spätgegner – dazu Arcade-Tempo (schnelles Feuer, 2 Start-Bomben). Die empfohlene Standard-Fassung.",
};
