...
| **Drei verrottete Gegenproben** (v69/v73/v75) — die Ankerprüfung lief nur im 50-min-Satz, jetzt 27. Tor mit 0,16 s | v75 |
...
| Überlappung: `--ohne-naht` kostete **142 s** und maß nichts — Nahtfrage einmal vorne, jetzt **4,9 s** | v82 |
