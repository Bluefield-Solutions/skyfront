// Minimaler ZIP-Writer in reinem Node (zlib DEFLATE + CRC32) — keine npm-Abhängigkeit.
...
// entries: [{ name, data (Buffer) }] -> Buffer (Standard-ZIP, DEFLATE)
export function makeZip(entries, level = 9) {
  const local = [], central = [];
  let offset = 0;
